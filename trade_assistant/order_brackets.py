...
def build_exit_order_drafts(plan: TradePlan) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _draft(plan.symbol, close_side, "TAKE_PROFIT_MARKET", first_tp_qty, one_half_r_price),
        _draft(plan.symbol, close_side, "TAKE_PROFIT_MARKET", second_tp_qty, two_r_price),
    ]
